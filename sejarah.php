<?php 
	...
	$sql = "SELECT sejarah FROM tb_profil";
	$proses = $conn->query($sql);
	$proses->data_seek(0);
	$sejarah = $proses->fetch_array(MYSQLI_ASSOC);
	$conn->close();
 ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<title>Sejarah <?php echo "$sekolah"; ?></title>
	...
	<body>
		...
		<div class="fluid header">
			...
			<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
				<h1>Sejarah Sekolah - <?php echo "$sekolah"; ?></h1>
				<p><?php echo $alamat ?></p>
		...
		<div class="container bayang ">
			...
			<h3 class="text-center">Sejarah Sekolah <?php echo "$sekolah"; ?></h3>
			<hr>
