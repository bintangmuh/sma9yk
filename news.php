...
<html>
	<head>
		...
		<title>Berita <?php echo "$sekolah"; ?></title>
	...
	<body>
		...
		<div class="container bayang ">
			...
			<h3 class="text-center">Berita Sekolah <?php echo "$sekolah"; ?></h3>
			<hr>
			<?php
				...
				?>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 post-hover">
				...
				<?php 
					if ($count < $rows) {
					// lihat selebihnya
					echo '<a class="btn btn-primary" href="news.php?postcount='.($count+5).'"><span class="glyphicon glyphicon-chevron-down"></span> Lihat Selebihnya</a>';
				}
				?>
		</div>
